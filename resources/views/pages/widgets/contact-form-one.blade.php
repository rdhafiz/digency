...
<section class="contact-us-section sec-wrap" id="contact">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center mb-5">
                <h4 class="sec-title mb-4">Get In Touch</h4>
            </div>
            ...
            <div class="col-12">
                <form action="" class="contact-form">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group contact-input-wrap mb-3">
                        ...
                        <div class="col-lg-7">
                            <div class="form-group contact-input-wrap">
                                <textarea class="form-control contact-input" placeholder="Your Message*" name="" id="" cols="30" required
                                          rows="8"></textarea>
                            </div>
                        </div>
